...
router.get('/article/update/:id', (req, res) => adminArticleController.getEditArticle(req, res));

// Update article (better: use id)
router.post('/article/update/:id', (req, res) => adminArticleController.updateArticle(req, res));
